...
//            }
            ...
            mScaleGestureDetector =
                    new ScaleGestureDetector(ProductImageActivity.this, new ScaleListener());
        }
    }
    ...
    private class ScaleListener
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            ...
            imvProductImageView.setScaleX(mScaleFactor);
            imvProductImageView.setScaleY(mScaleFactor);
            return true;
        }
    }
}
